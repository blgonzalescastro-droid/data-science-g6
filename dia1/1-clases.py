#PROGRAMACION ORIENTRADA A OBJETOS (POO)
# Las clases son plantillas para crear objetos (instancias)
# Una clase puede tener atributos (caracteristicas ) y métodos (funciones)
class Automovil:
    ...
    def encender(self):
        print(f"Encendiendo  el automovil {self.marca} con placa {self.placa}")
